# ComfyUI-StoryboardLoader

스토리보드 기반으로 배경 이미지, 캐릭터 이미지, 장면 프롬프트를 자동으로 매칭해서 출력하는 ComfyUI 커스텀 노드입니다.
...
git clone https://github.com/YOUR_USERNAME/ComfyUI-StoryboardLoader
```

ComfyUI 재시작 후 노드 검색에서 **"Storyboard Loader"** 로 찾을 수 있습니다.
